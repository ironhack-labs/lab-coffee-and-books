document.addEventListener('DOMContentLoaded', () => {
  ...
  window.coffeebooks.forEach( coffeebook => {
    new google.maps.Marker({
      position: {
       
        lat: coffeebook.location.coordinates[0],
        lng: coffeebook.location.coordinates[1]
      },
      map: map,
      title: `${coffeebook.name} - ${coffeebook.description}`
    });
  })
